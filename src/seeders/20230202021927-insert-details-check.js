...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        return queryInterface.bulkInsert("details_checklists", [
            {
                details:
                    "สายไฟเสียหาย (เห็นสายไฟอ่อน / เส้นลวดทองแดง / สายไฟละลาย / มีความร้อน / สีเปลี่ยนจากเดิม ) ฉนวนของสายไฟฟ้ต้องไม่มีการแตกกรอบ ไม่มีรอยไหม้ , บวม , เปลือกสายไฟไม่เปลี่ยนสี",
